 ...
 * v1 = (v1 + v2) *v3
 */
void addThenMultiply(void *v1, void *v2, void *v3, void ptrAdd(void *v1, void *v2), void ptrMul(void *v1, void *v2))
{
	ptrAdd(v1, v2);
	ptrMul(v1, v3);
}
...
void test_addThenMultiply_given_2p3_plus_3p4_times_4p5_should_get_25p65(void)
{
...
void test_explore_function_pointer(void)
{
	...
	*p = 20;
	...
	ptr2Func = add;
	printf("2 + 4: %d\n", add(2, 4));
	printf("3 + 7: %d\n", ptr2Func(3, 7)); //*ptrFunc also can use
}
